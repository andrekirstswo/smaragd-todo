...
public class BoardController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] CreateBoardDto model, CancellationToken cancellationToken = default)
    {
    ...
    {
        var result = await _mediator.Send(new GetBoardByIdQuery(id), cancellationToken);
    ...
    {
        var result = await _mediator.Send(new GetBoardNameByIdQuery(id), cancellationToken);
